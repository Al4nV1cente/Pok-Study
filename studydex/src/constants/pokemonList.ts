export const GEN1_POKEMON_LIST = [
...
// Simple lookup database of types of Gen 1 to display accurate silhouettes and guesses if needed
export const GEN1_TYPES: Record<string, string[]> = {
